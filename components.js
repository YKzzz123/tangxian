...
const translations = {
    ...
    en: {
        'site.title': 'Traces of Immortals in Tang Dynasty',
        'site.subtitle': 'Analysis of Immortal Imagery in Tang Dynasty Wonderland Poetry',
        'nav.home': 'Home',
        'nav.immortals': 'Immortals',
        'nav.exhibition': 'Digital Exhibition',
        'nav.create': 'Poetry Creation',
        'nav.about': 'About Us',
        'theme.title': 'Theme Mode',
        'theme.default': 'Default',
        'theme.dark': 'Dark',
        'theme.eye': 'Green',
        'index.subtitle': 'Analysis of Immortal Imagery in Tang Dynasty Wonderland Poetry',
        'index.about': 'About This Project',
        'index.explore': 'Explore Content',
        'index.immortals.title': 'Immortals',
        'index.immortals.desc': 'Explore Various Immortal Figures and Legends',
        'index.immortals.detail': 'Systematically organize immortal imagery in Tang Dynasty wonderland poetry based on gender, type, and frequency, showcasing a rich and diverse world of immortals from distinctive celestial beings to typified immortals.',
        'index.immortals.enter': 'Explore',
        'index.exhibition.title': 'Digital Exhibition',
        'index.exhibition.desc': 'Immortal Imagery in Tang Dynasty Wonderland Poetry',
        'index.exhibition.detail': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry across the entire Tang Dynasty and different periods, experiencing the unique style of this era.',
        'index.exhibition.enter': 'Enter Exhibition',
        'index.create.title': 'Poetry Creation',
        'index.create.desc': 'Create Your Own Wonderland Poetry',
        'index.create.detail': 'Complete the "Tang Dynasty Wonderland Poetry Test" to find a poet that matches your temperament, then select your favorite immortal imagery and wonderland scenes to generate your own "Tang Dynasty Wonderland Poetry".',
        'index.create.enter': 'Start Creating',
        'index.stats.poets': 'Tang Poets',
        'index.stats.poems': 'Wonderland Poems',
        'index.stats.immortals': 'Immortal Imagery',
        'index.about.text1': 'The Tang Dynasty was a brilliant era in the history of Chinese poetry. Due to the "kinship" between the Tang royal family and Laozi, the founder of Taoism, Taoism flourished throughout the country. Its core belief—the concept of immortals—was widely spread and deeply penetrated all social strata.',
        'index.about.text2': 'As Taoism\'s pursuit of immortality aligned perfectly with the literati\'s psychological quest for eternal life, its myths, legends, and religious activities provided abundant materials and rich imagery. Tang literati were eager to revere Taoism, and their spiritual pursuit of immortality greatly stimulated poetry creation.',
        'index.about.text3': 'Against this background, Tang Dynasty wonderland poetry reached unprecedented prosperity.',
        'index.about.quote': '"Rainbow as garments, wind as steeds, cloud lords descend in multitudes"',
        'index.about.quote.author': '— Li Bai, "Farewell to a Friend on a Dream Journey to Mount Tianmu"',
        'index.about.image.caption': 'Immortal imagery in Tang Dynasty wonderland poetry often merges with natural mountains, rivers, clouds, mist, and stars',
        'index.explore.desc': 'Deeply explore the world of immortals in Tang Dynasty wonderland poetry, experiencing the rich imagination and spiritual pursuits of the ancients',
        'footer.description': 'A Digital Humanities Museum of Immortal Imagery in Tang Dynasty Wonderland Poetry, dedicated to recreating the immortal world depicted by Tang poets through digital technology.',
        'footer.quickLinks': 'Quick Links',
        'footer.resources': 'Resources',
        'footer.dataset': 'Tang Wonderland Poetry Dataset',
        ...
        'footer.copyright': '© 2025 Traces of Immortals in Tang Dynasty - Digital Humanities Museum of Immortal Imagery in Tang Dynasty Wonderland Poetry. All Rights Reserved.',
        'footer.disclaimer': 'This project is for academic research and cultural dissemination only.',
        'exhibition.title': 'Analysis of Immortal Imagery in Tang Dynasty Wonderland Poetry',
        'exhibition.subtitle': 'Explore the creative trends, immortal imagery, co-occurrence relationships, and GIS analysis of immortal locations in wonderland poetry across the Tang Dynasty and its different periods.',
        'exhibition.nav.visualization': 'Visualization Analysis',
        ...
        'exhibition.nav.cooccurrence': 'Immortal Imagery Co-occurrence Analysis',
        ...
        'chart.tooltip.people': 'people',
        'chart.tooltip.female.ratio': 'Female Immortal Ratio',
        ...
        'chart.series.poem.count': 'Wonderland Poem Count',
        'chart.series.male.immortals': 'Male Immortals',
        'chart.series.female.immortals': 'Female Immortals',
        'chart.series.female.ratio': 'Female Immortal Ratio',
        'chart.series.occurrence': 'Occurrence',
        'chart.series.immortal.frequency': 'Immortal Imagery Frequency',
        'chart.legend.male': 'Male',
        'chart.legend.female': 'Female',
        'chart.legend.mortal.immortal': 'Mortal Immortals',
        'chart.legend.distinct.immortals': 'Distinct Celestial Immortals',
        'chart.legend.typed.immortals': 'Typed Immortals',
        'chart.network.title': 'Immortal Imagery Co-occurrence Network',
        'chart.network.subtitle': 'Node size represents frequency, line color represents relationship source',
        'chart.period.chu': 'Early Tang',
        'chart.period.sheng': 'High Tang',
        'chart.period.zhong': 'Mid Tang',
        'chart.period.wan': 'Late Tang',
        'exhibition.overview.title': 'Overview of Wonderland Poetry',
        'exhibition.overview.text1': 'Wonderland poetry is a type of poetry in which poets express their misanthropic feelings or desire for immortality through themes such as world-weariness, seeking immortals, visiting Taoist masters, and traveling to wonderlands. It takes illusory imagery such as immortals, wonderlands, and immortal techniques as core imagery, and among these, immortal imagery is the core of the core.',
        'exhibition.overview.text2': 'Let us explore the immortal imagery in Tang Dynasty wonderland poetry and its evolution trajectory to understand the spirit of the times and humanistic thoughts of that era.',
        'immortals.title': 'Atlas of Immortal Imagery in Tang Dynasty Wonderland Poetry',
        'immortals.subtitle': 'Explore various immortal figures in Tang Dynasty wonderland poetry, experiencing the ancients\' rich imagination of wonderlands and their longing for immortality',
        'immortals.filter.all': 'All Immortals',
        'immortals.filter.distinct': 'Distinctive Celestial Immortals',
        'immortals.filter.mortal': 'Mortals Who Became Immortals',
        'immortals.filter.typed': 'Typified Immortals',
        'immortals.filter.female': 'Female',
        'immortals.filter.male': 'Male',
        'immortals.period.filter': 'Period Filter:',
        'immortals.period.all': 'All',
        'immortals.period.chu': 'Early Tang',
        'immortals.period.sheng': 'High Tang',
        'immortals.period.zhong': 'Mid Tang',
        ...
        'exhibition.chart.period.percentage': 'Percentage of Wonderland Poems by Period in Tang Dynasty',
        'exhibition.chart.period.count': 'Number of Wonderland Poems by Period in Tang Dynasty',
        'exhibition.overview.quanTangShi': 'Quan Tang Shi (Complete Tang Poems) is a collection of Tang poetry compiled in 1705 under the leadership of Emperor Kangxi of the Qing Dynasty. "It contains more than 48,900 poems by more than 2,200 poets, divided into 900 volumes." Based on Yan Jinxiong\'s "Research on Tang Dynasty Wonderland Poetry," there are 282 wonderland poems in Quan Tang Shi, accounting for 0.94% of the total. Among them, Early Tang has 52, High Tang has 79, Mid Tang has 67, and Late Tang has 84.',
        'exhibition.poet.title': 'Number of Wonderland Poems by Tang Poets',
        'exhibition.poet.text1': 'Based on statistical analysis of 282 wonderland poems in Quan Tang Shi, 83 poets participated in the creation of wonderland poetry. The distribution of their creative output is extremely uneven, with Li Bai leading far ahead with 57 wonderland poems, accounting for 20.2% of the total. This distribution reflects individual differences in wonderland poetry creation and the influence of "masters."',
        'exhibition.poet.text2': 'The chart below shows the top 20 poets with the most wonderland poems. From the data, it can be seen that only a few poets (such as Li Bai, Cao Tang, Song Zhiwen, etc.) created a large number of wonderland poems, while most poets only created 1-2 poems.',
        'exhibition.poet.chart.title': 'Ranking of Tang Poets by Number of Wonderland Poems (Top 20)',
        'exhibition.poet.chart.text': 'The chart shows the ranking of the number of wonderland poems in the Tang Dynasty. Li Bai, Cao Tang, Song Zhiwen, Lu Guimeng, and Li Shangyin are the Tang literati who wrote the most wonderland poems, with Li Bai writing as many as 57 poems.',
        'exhibition.period.title': 'Distribution of Immortal Imagery Across Different Periods',
        'exhibition.period.text1': 'In 282 Tang Dynasty wonderland poems, immortal imagery appears 340 times in total, including 135 immortals. The frequency and number of immortal imagery also vary across different periods.',
        'exhibition.period.chart.frequency': 'Frequency of Immortal Imagery by Period in Tang Dynasty',
        'exhibition.period.chart.top20': 'Most Frequently Appearing Immortal Imagery in Tang Dynasty Wonderland Poetry (Top 20)',
        'exhibition.period.chart.heatmap': 'Heatmap of Temporal Distribution of Major Immortal Imagery',
        'exhibition.period.chart.trend': 'Temporal Distribution and Popularity Trends of Major Immortal Imagery (Top 5)',
        'exhibition.period.chart.distribution': 'Temporal Distribution',
        'exhibition.period.chart.popularity': 'Popularity Trend',
        'exhibition.period.text2': 'The chart shows the ranking of the frequency of immortal imagery in Tang Dynasty wonderland poetry. Queen Mother of the West, Wang Ziqiao, Magu, Jade Emperor, and Nongyu are the most frequently appearing immortal imagery in Tang Dynasty wonderland poetry, and their frequency also fluctuates across different periods.',
        'exhibition.period.text3': 'Through this ranking, we can also see that among the most frequently appearing immortal imagery, the number of female immortals is by no means less than that of male immortals.',
        'exhibition.gender.title': 'Gender Study of Immortal Imagery',
        'exhibition.gender.text1': 'Among these 135 immortals, there are 95 male immortals and 40 female immortals.',
        'exhibition.gender.text2': 'It is not difficult to find an interesting phenomenon: the proportion of female immortal imagery is gradually increasing, and even exceeded the number of male immortals in the Mid Tang period.',
        'exhibition.gender.chart.distribution': 'Gender Distribution of Immortal Imagery',
        'exhibition.gender.chart.period': 'Gender Distribution of Immortal Imagery by Period in Tang Dynasty',
        'exhibition.gender.chart.trend': 'Trend of Female Immortal Imagery Proportion',
        'exhibition.gender.tooltip': 'Why is the proportion of female immortal imagery gradually increasing?',
        'exhibition.gender.text3': 'After the An-Shi Rebellion in the Mid Tang, social morals declined, and people focused on real pleasures, leading to the prevalence of romantic relationships with female Taoist priests in society. In the eyes of Mid Tang literati, celestial maidens possessed extraordinary beauty and could best satisfy their desires for pleasure. Moreover, they were well-versed in Taoist arts, and obtaining them was equivalent to finding the secret to immortality.',
        'exhibition.gender.text4': 'Therefore, the immortalization of romantic love became a common phenomenon in wonderland poetry during this period. Love between male and female Taoists, between scholars and female Taoist priests, between scholars and courtesans, love in the secular world, and even love between emperors and concubines were all placed in wonderland settings.',
        'exhibition.type.title': 'Type Study of Immortal Imagery',
        'exhibition.type.text1': 'From the perspective of imagery connotation, the immortal imagery in Tang Dynasty wonderland poetry can be divided into three major categories: typified immortals, mortals who became immortals, and distinctive celestial immortals.',
        'exhibition.type.text2': '· Typified immortals refer to immortal imagery that lacks individuality in wonderland poetry and only appears as representatives of the immortal group, such as "Jade Maiden" and "Feathered Man";',
        'exhibition.type.text3': '· Mortals who became immortals, as the name suggests, refer to those who were originally mortals but later became immortals through encounters with immortals or through self-cultivation and consuming elixirs. Typical examples of this type of immortal imagery are Wang Ziqiao, Yellow Emperor, and Huang Chuping;',
        'exhibition.type.text4': '· Distinctive celestial immortals refer to those immortals who were particularly cared for and carefully depicted by wonderland poets, thus having distinctive individual characteristics, such as Queen Mother of the West, Jade Emperor, and Du Lanxiang.',
        'exhibition.type.text5': 'Among these 135 immortals, nearly half are mortals who became immortals. Tang poets incorporated such imagery into wonderland poetry to express their ideals of ascending to immortality and their devout faith in Taoism.',
        'exhibition.type.chart.percentage': 'Proportion of Immortal Imagery by Type',
        'exhibition.type.chart.count': 'Number of Immortal Imagery by Type',
        'exhibition.cooccurrence.text1': 'Based on social network analysis of co-occurrence data of immortal imagery in Tang Dynasty wonderland poetry, we can explore the relationships between different immortals through visualized network graphs. In the network graph, nodes represent immortals, node size represents frequency of appearance, connections represent co-occurrence relationships between immortals, and the thickness and color of connections represent the strength of relationships.',
        'create.generate.btn': 'Generate Poetry',
        ...
        'create.generate.success.title': 'Poetry Generated',
        ...
        'create.panel.imagery': 'Immortal Imagery',
        'create.panel.scene': 'Wonderland Scene',
        'create.panel.selected.imagery': 'Imagery:',
        'create.panel.selected.scene': 'Scene:',
        'create.page.description': 'First complete the Tang Dynasty Wonderland Poetry Test to find a poet that matches your temperament, then select immortal imagery and wonderland scenes in their style to generate your own five-character quatrain.',
        'period.nav.all': 'All Tang',
        'period.nav.chu': 'Early Tang',
        'period.nav.sheng': 'High Tang',
        'period.nav.zhong': 'Mid Tang',
        'period.nav.wan': 'Late Tang',
        'period.nav.visualization': 'Visualization Analysis',
        'period.nav.overview': 'Overview',
        'period.nav.poems': 'Representative Poems',
        'period.nav.development': 'Development Status',
        'period.nav.image': 'Sources of Major Immortal Imagery',
        'period.subtitle': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry during the {period} period, experiencing the unique style of this era.',
        'period.chu.subtitle': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry during the Early Tang period, experiencing the unique style of this era.',
        'period.sheng.subtitle': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry during the High Tang period, experiencing the unique style of this era.',
        'period.zhong.subtitle': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry during the Mid Tang period, experiencing the unique style of this era.',
        'period.wan.subtitle': 'Explore the development status, distribution, and sources of immortal imagery in wonderland poetry during the Late Tang period, experiencing the unique style of this era.',
        'period.chu.title': 'Early Tang Wonderland Poetry—Emerging Signs, Connecting Past and Future',
        'period.sheng.title': 'High Tang Wonderland Poetry—Magnificent Spectacle, Reaching the Peak',
        'period.zhong.title': 'Mid Tang Wonderland Poetry—Broken Wings in the Clouds, Falling to Earth',
        'period.wan.title': 'Late Tang Wonderland Poetry—Brilliant Radiance, Shining Brightly',
        'period.history': 'Historical Background',
        'period.chu.history': 'During the Early Tang period (618-704 CE), the Li Tang royal family claimed descent from Laozi (Li Er) and vigorously promoted Taoism. This policy led to the widespread dissemination of Taoism in society, and wonderland poetry, as an important carrier of Taoist culture, flourished accordingly.',
        'period.chu.overview': 'Although Tang Dynasty wonderland poetry is magnificent, its development across different periods was uneven. The Early Tang was a relatively quiet period for wonderland poetry creation. This is related to the fact that the Early Tang royal family\'s reverence for Taoism was mainly for political purposes to elevate their social status, rather than a genuine belief in immortals, as well as the social satisfaction psychology caused by the strong national power of Early Tang.',
        ...
        'period.development.text1': 'The number of {period} wonderland poems is only {count}, with the frequency and number of immortal imagery being {freq} and {num} respectively, the least among the four periods of the Tang Dynasty.',
        'period.development.text2': 'The number of {period} wonderland poets is also relatively scarce, with only {poets}. Representative writers include {names}.',
        'period.chu.development.text1': 'The number of Early Tang wonderland poems is only 52, with the frequency and number of immortal imagery being 17 and 11 respectively, the least among the four periods of the Tang Dynasty.',
        'period.chu.development.text2': 'The number of Early Tang wonderland poets is also relatively scarce, with only 20. Representative writers include Song Zhiwen, Lu Zhaoling, Shen Quanqi, and Wang Bo.',
        'period.chart.percentage': '{period} Wonderland Poetry Proportion',
        'period.chart.poets': 'Ranking of {period} Poets by Number of Wonderland Poems',
        'period.chu.chart.percentage': 'Early Tang Wonderland Poetry Proportion',
        'period.chu.chart.poets': 'Ranking of Early Tang Poets by Number of Wonderland Poems',
        'period.sheng.chart.percentage': 'High Tang Wonderland Poetry Proportion',
        'period.sheng.chart.poets': 'Ranking of High Tang Poets by Number of Wonderland Poems',
        'period.sheng.chart.percentage.name': 'Wonderland Poetry Proportion',
        ...
        'period.sheng.chart.type.mortal': 'Mortals Who Became Immortals',
        'period.sheng.chart.type.distinct': 'Distinctive Celestial Immortals',
        'period.sheng.chart.type.typed': 'Typified Immortals',
        'period.sheng.chart.period.sheng': 'High Tang',
        'period.sheng.chart.period.all': 'All Tang',
        'period.zhong.chart.percentage': 'Mid Tang Wonderland Poetry Proportion',
        'period.zhong.chart.poets': 'Ranking of Mid Tang Poets by Number of Wonderland Poems',
        'period.wan.chart.percentage': 'Late Tang Wonderland Poetry Proportion',
        'period.wan.chart.poets': 'Ranking of Late Tang Poets by Number of Wonderland Poems',
        'period.chart.immortals': 'Ranking of Immortal Imagery Frequency',
        'period.chart.typeGender': 'Distribution of Immortal Imagery by Type and Gender',
        'period.sheng.history': 'During the High Tang period (705-770 CE), the economy prospered, culture was open and diverse, and thought was free and active. The royal family\'s active promotion of Taoism provided fertile ground for wonderland poetry creation. During this period, wonderland poetry experienced a significant flourishing.',
        'period.sheng.overview': 'The High Tang was a golden age for the development of wonderland-themed literary works. Unlike the relatively quiet situation of Early Tang wonderland poetry creation, High Tang wonderland poetry experienced a significant flourishing—the number of poems increased substantially, and the immortal imagery contained in the poems became particularly vivid and profound.',
        'period.zhong.history': 'During the Mid Tang period (771-835 CE), the wounds of the An-Shi Rebellion had not yet healed, political chaos such as regional separatism and eunuch autocracy occurred frequently, and literati generally fell into a dual dilemma of ideal and reality. Against this historical background, wonderland poetry became an important literary form for literati to vent their inner anxiety and seek spiritual solace.',
        'period.zhong.overview': 'The flames of the An-Shi Rebellion ended the prosperity of the High Tang, plunging the Tang Dynasty into a historical turning point from prosperity to decline. The political changes, economic decline, and people\'s suffering caused by social turmoil profoundly reshaped the spiritual world of literati—the confident and enterprising sentiment of the High Tang gradually dissolved, replaced by confusion, anxiety, and an urgent need for spiritual comfort.',
        ...
        'period.wan.overview': 'The flames of the Huang Chao Rebellion and the iron hooves of regional separatism completely shattered the last dream of revival of the Tang Dynasty, dragging society into a fragmented end-of-dynasty picture. Political corruption, people\'s suffering, and the shadow of the dynasty\'s collapse together brewed the spiritual bitterness of Late Tang literati—the confident spirit of the High Tang had long been worn away, and the confusion and anxiety of the Mid Tang had settled into a deeper sense of disillusionment and powerlessness.',
        'period.zhong.overview2': 'Taoism, as an important spiritual refuge at that time, was reinterpreted by Mid Tang literati: they no longer clung to the romantic transcendence of Lao-Zhuang metaphysics, but instead sought paths for spiritual peace from Taoist principles and immortal legends, either using immortal tales to explain cultivation concepts, or using immortal imagery to reflect real-world dilemmas, or endowing immortals with human emotions to express personal feelings.',
        ...
        'period.zhong.development.text1': 'The number of wonderland poems in the Mid Tang period decreased to 67 compared to the High Tang, with the frequency and number of immortal imagery being 72 and 43 respectively.',
        'period.zhong.development.text2': 'The number of poets in the Mid Tang reached the peak of the four periods, with 29 wonderland poets recorded in works.',
        'period.zhong.development.text3': 'The number of wonderland poems in the Mid Tang period decreased to 67 compared to the High Tang, with the frequency and number of immortal imagery being 72 and 43 respectively. During this period, new immortal imagery such as "Chang\'e" and "Guang Chengzi" appeared. For example, in Li He\'s "Peony Planting Song": "How high is the osmanthus tree in the moon? Ask the tree cutter from Xihe. Chang\'e pounds medicine endlessly, the jade maiden plays pitch-pot without return." And in Meng Jiao\'s "Seeking Immortality Song": "Guang Chengzi loves the divine cauldron, Huainan likes the elixir scriptures." From the perspective of immortal types, wonderland poetry first appeared with ugly immortal imagery, that is, immortals who were deliberately vilified in appearance, actions, and character, and were ultimately negated and criticized by poets. In addition, female immortal imagery increased significantly and showed a tendency toward eroticism. Reviewing Mid Tang wonderland poetry, we find that the number of female immortal imagery is about to exceed that of male immortal imagery.',
        ...
        'period.wan.feature.3': 'Secularization and tragic turn of immortal imagery',
        'period.wan.feature.4': 'Questioning of the order of fate and inquiry into individual destiny',
        'period.wan.development.text1': 'The number of wonderland poems in the Late Tang period reached 84, with the frequency and types of immortal imagery being 146 and 80 respectively.',
        'period.wan.development.text2': 'The number of wonderland poets in this period decreased, with 24 poets recorded in works, among whom Cao Tang created the most.',
        'period.wan.development.text3': 'During this period, "An Qisheng" and "Du Lanxiang" appeared. For example, in Wei Zhuang\'s "Visiting a Friend in Xunyang Without Meeting": "Not seeing An Qi, I regret going upstairs, lonely people face the egret\'s sorrow." In Cao Tang\'s "Small Wonderland Poems" (No. 37): "An Qi lifted the jade cup, discussing kingship and hegemony together." In Li Shangyin\'s "Revisiting the Saintess Shrine": "E Lu Hua comes without a fixed place, Du Lanxiang leaves without delay." Although the immortals of this period were still mainly "mortals who became immortals" and "distinctive celestial immortals," Late Tang wonderland poets depicted them according to real-life experiences, achieving complete humanization of immortal imagery, with immortal aura fading and human aura intensifying.',
        ...
        'period.wan.duLanXiang.description': 'Du Lanxiang\'s mythological prototype first appeared in Gan Bao\'s "In Search of the Supernatural" of the Eastern Jin Dynasty, with the core narrative being "a young girl from the Xiang River was adopted by a fisherman, later met by a green boy, who revealed \'I am an immortal maiden, banished to the human world for faults, now leaving,\' and left a poem for her beloved Zhang Shuo before ascending to immortality." At this time, the image focused on "banished immortal redemption, returning to heaven," with thin emotional coloring. In the Early and High Tang periods, poets mostly used her "ascension to immortality" trait to metaphorize "transcending the secular world." Although Li Bai did not directly write about her, he alluded to her prototype in "Ancient Airs" with "immortal maiden banished to the human world."',
        'period.literature.title': 'Related Literary Records (Original Text)',
        'period.chu.wangziqiao.title': 'Prince Ziqiao',
        ...
        'period.chu.wangziqiao.description': 'Records of Prince Ziqiao first appeared in "Lie Xian Zhuan" (Biographies of Immortals), also known as Wang Qiao, Wang Jin, or Wang Zijin, the crown prince of King Ling of Zhou. He loved playing the sheng (a wind instrument), and the sound was as clear and pleasant as a phoenix\'s cry. He once traveled to the Yiluo region, where the Daoist Fuqiu Gong took him to Mount Songgao. Over thirty years later, he met Bai Liang and told his old friend: "You can inform my family to wait for me on Mount Gou on the seventh day of the seventh month." On that day, Prince Ziqiao indeed appeared among the peaks riding a white crane, visible but unreachable. He merely nodded to his family from the sky for several days before departing. Later generations built a temple for him on Mount Goushi as a memorial.',
        'period.chu.xiwangmu.title': 'Queen Mother of the West',
        ...
        'period.chu.xiwangmu.description': 'The Queen Mother of the West is a goddess in ancient Chinese mythology. Early records of her mythology appear in "Shan Hai Jing" (Classic of Mountains and Seas), describing her as a totemic deity with animal-like features. During the Han Dynasty, when the pursuit of immortality was extremely popular, the image of the Queen Mother of the West as a long-lived immortal was established. Han Dynasty folk believed she had the power to grant longevity, fortune, and prosperity. Taoism absorbed and transformed the pre-Qin mythology of the Queen Mother of the West, portraying her in works like "Yongcheng Jixian Lu" as an elegant and graceful female immortal. In Taoist immortal doctrine, Mount Kunlun has the revered deity Queen Mother of the West, who holds the elixir of immortality and governs human life and death, and is granted the divine status of ruler of all female immortals, claiming that all women who achieve immortality in heaven, earth, the three realms, and the ten directions are under her jurisdiction.',
        'period.chu.dongfangshuo.title': 'Dongfang Shuo',
        ...
        'period.chu.dongfangshuo.description': 'Biographies of Dongfang Shuo from the Han Dynasty are recorded in Sima Qian\'s "Records of the Grand Historian" and Ban Gu\'s "Book of Han". During the reign of Emperor Wu of Han, the ambitious and fame-seeking Dongfang Shuo, who had entered the court but failed to gain promotion for a long time, expressed feelings of unrecognized talent and repeatedly voiced desires to retire, thus becoming known to later generations as a seeker of office and a court recluse. After the Jin Dynasty, Dongfang Shuo\'s image changed: his solemn image was gradually dissolved by new cultural trends, showing more wit and unrestrained characteristics. At the same time, with the popularity and systematization of immortal doctrines, Dongfang Shuo\'s image was also "immortalized," and it was said that he was the incarnation of the Great White Star. The phenomenon of Dongfang Shuo being gradually immortalized and then included in the Taoist pantheon of immortals was a result of Taoism expanding its system.',
        'references.dataset.title': 'Complete Tang Dynasty Wonderland Poetry Dataset',
        'references.dataset.desc': 'The Complete Tang Dynasty Wonderland Poetry dataset used by this platform contains all poetry works with immortal imagery from the Tang Dynasty period, classified and organized by different categories',
        ...
        'references.dataset.structure.item1': 'Wonderland Poems in Complete Tang Poems: All wonderland poems in Complete Tang Poems, stored in JSON format',
        'references.dataset.structure.item2': 'Immortal Imagery Summary: Contains all immortal imagery appearing in Complete Tang Poems, stored in CSV format',
        'references.dataset.structure.item3': 'Immortal Imagery Geographic Summary: A correspondence table between immortals and wonderlands based on the immortal imagery summary, organized by AI and manually fine-tuned, stored in JSON format',
        ...
        'period.sheng.feature.3': 'Smooth and natural language, breaking through the formal constraints of Early Tang',
        ...
        'period.sheng.development.text1': 'The number of wonderland poems in the High Tang period increased to 79, with the types of immortal imagery appearing in the poems increasing to 59. The images of immortals became more full, their personalities more distinct, and their connotations richer.',
        'period.sheng.development.text2': 'Although many literati in the High Tang period came into contact with Taoism, few poets created wonderland poetry. Only 10 wonderland poets are recorded in works, and only Li Bai truly devoted himself wholeheartedly to the creation of wonderland poetry.',
        'period.sheng.development.text3': 'During this period, in addition to immortals such as "Queen Mother of the West" and "Wang Ziqiao," immortal imagery such as "Magu," "Nongyu," and "Yellow Emperor" also appeared. For example, in the poetic immortal Li Bai\'s "You Suo Si" and "Flying Dragon Songs" (No. 1): "The blue bird from the west flies east, I wish to send a letter to thank Magu" and "The Yellow Emperor cast a cauldron at Mount Jingshan, refined cinnabar, cinnabar became gold. Riding a dragon, he flew to the Great Purity, clouds of sorrow and sea thoughts make one sigh." In Wang Han\'s "Ode to the Bright Star Jade Maiden Altar, Seeing Off the Inspector to Huayin": "Jiang Fei\'s jade pendant remains as a memento, Ying Nu\'s silver flute is empty and self-pitying." In Wu Yun\'s "Ode to Great Scholars: Guang Chengzi": "Xuanyuan came with the wind, asked about the Way to cultivate spirit and form." From the perspective of immortal types, the High Tang period saw more mortals who became immortals such as "Yellow Emperor" and "Magu." Among them, Li Bai created a large number of immortal imagery. The immortals in his works transcended the limitations of Taoist stories, and through the portrayal of actions, language, and background, he endowed immortal imagery with vivid charm and spirit, giving immortal imagery a stronger individual character.',
        ...
        'period.sheng.maGu.description': 'Magu\'s legend first appeared in the Taoist text "Biographies of Immortals," where Magu was depicted as an immortal maiden with youthful appearance and extraordinary powers: she could freely travel between the human world and the immortal realm, and with a wave of her hand, could make flowers and plants bloom and grow. In legends, Magu often descended to the human world to gather herbs and refine elixirs, and was known for her kindness and helpfulness. "Longevity" is one of the most prominent characteristics of the "Magu" imagery in High Tang wonderland poetry. Legend has it that Magu had an extremely long lifespan, often associated with the concepts of "eternal youth" and "immortality." Poets used Magu\'s imagery to express their desire for health and longevity, as well as their longing for peace and happiness.',
        ...
        'exhibition.gis.text1': 'Through Geographic Information System (GIS) analysis, we can spatially visualize the immortals appearing in Tang Dynasty wonderland poetry according to their locations. These immortal locations cover multiple categories including core immortal mountains, celestial wonderlands, mountain and river secrets, water realm secrets, and Taoist holy sites, showcasing the rich spatial imagination in Tang Dynasty wonderland poetry.',
        ...
        'exhibition.gis.text3': 'From the map distribution, it can be seen that immortal locations are mainly concentrated in the eastern and central regions of China, with core immortal mountains such as Kunlun Mountain, Penglai Mountain, and Zhongnan Mountain being the locations with the highest frequency of immortal imagery. Although celestial wonderlands are relatively concentrated geographically, they occupy an important position in literary imagination. These geographical distributions reflect Tang Dynasty poets\' understanding and imagination of traditional immortal mountains and Taoist holy sites.',
        ...
        'create.intro.1': 'Under the poetic starry sky of the High Tang, wonderland-traveling poems shine like a galaxy,',
        ...
        'create.dataSource': 'Data Source: Quan Tang Shi Wonderland Poems Dataset',
        ...
        'us.page.subtitle': 'The Traces of Immortals in Tang Dynasty team is dedicated to exploring the world of immortals in Tang Dynasty wonderland poetry through digital humanities methods',
        'us.team.title': 'Project Team',
        ...
        'us.research.purpose.text': 'Wonderland poetry centers on illusory imagery such as immortals, wonderlands, and immortal techniques, with immortal imagery being the core of the core. Analyzing immortal imagery helps to deeply understand the spiritual atmosphere of Tang literati wonderland poetry and gain insights into the zeitgeist and humanistic thought. Visualizing the analysis results can clearly present the evolution of immortal imagery and further explore the influence of Taoist development and social changes on wonderland poetry creation.',
        'us.research.datasource.title': 'Dataset Sources',
        'us.research.datasource.text': 'We discovered a well-organized JSON dataset of the Complete Tang Poems on GitHub, and combined it with Yan Jinxiong\'s "Research on Tang Dynasty Wonderland Poetry" and manual proofreading to extract over 280 Tang Dynasty wonderland poems. The dataset is provided in both JSON and CSV formats, laying the foundation for subsequent corpus analysis and visualization.',
        ...
        'us.workflow.step0.range': '29/09/2025 - 12/10/2025',
        'us.workflow.step0.title': 'Dataset Organization & Immortal Imagery Extraction',
        'us.workflow.step0.desc': 'Based on the GitHub Complete Tang Poems JSON dataset and "Research on Tang Dynasty Wonderland Poetry", we screened 282 Tang Dynasty wonderland poems, classified them into four periods, and organized the immortal imagery appearing in the poems according to typological analysis requirements.',
        'us.workflow.step0.tools.title': 'Methodology & Tools',
        'us.workflow.step0.tool1': 'Doubao AI OCR: Identified all wonderland poetry information in "Research on Tang Dynasty Wonderland Poetry".',
        ...
        'us.workflow.step0.tool3': 'Feishu Multi-dimensional Table with DeepSeek integration: Extracted immortal imagery from wonderland poetry and organized it into CSV format.',
        'us.workflow.step1.range': '13/10/2025 - 26/10/2025',
        'us.workflow.step1.title': 'Multi-dimensional Data Analysis & Visualization',
        'us.workflow.step1.desc': 'Conducted data analysis on immortal imagery usage and representative poets across the Complete Tang, Early Tang, High Tang, Mid Tang, and Late Tang periods, including statistical analysis, immortal imagery co-occurrence analysis, and GIS analysis of immortal locations.',
        ...
        'us.workflow.step1.tool3': 'Python: Performed data cleaning and analysis, calculated immortal imagery co-occurrence relationships.',
        'us.workflow.step1.tool4': 'AI + ECharts: Created co-occurrence network diagrams of immortal imagery in Tang Dynasty wonderland poetry.',
        ...
        'us.workflow.step2.desc': 'Combined data results with relevant literature to write about the characteristics of immortal imagery usage in wonderland poetry across different periods, sources of high-frequency imagery and their cultural contexts, and discussed derivative insights such as the increasing proportion of female immortals.',
        ...
        'us.workflow.step3.desc': 'Built the overall information architecture and interactive flow of Traces of Immortals in Tang Dynasty, presenting research results in a digital humanities approach.',
        ...
        'us.workflow.step4.desc': 'Designed the "Tang Dynasty Wonderland Chronicles" mini-game, allowing users to find poets that match their temperament through Q&A, select favorite immortal imagery and wonderland scenes, and generate their own "Tang Dynasty Wonderland Poetry".',
